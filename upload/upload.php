<?php
    ...
    if (isset($_POST['modal_upload_submit'])) {
        ...
        $isValidType = true; // No filename policy
            ...
            if (in_array($ext, ['pdf', 'jpg', 'jpeg', 'png'])) {
                try {
                    ...
                    if (move_uploaded_file($file['tmp_name'], $targetDir . $fileName)) {
                        ...
                        // Explicit remarks map matching exact DB column names
                        $remarksFieldMap = [
                            'TORPath'                    => 'Remarks',
                            'DiplomaPath'                => 'DiplomaRemarks',
                            'Form137Path'                => 'Form137Remarks',
                            'ALSCertificatePath'         => 'ALSCertificateRemarks',
                            'PSAPath'                    => 'PSARemarks',
                            'MarriageCertificatePath'    => 'MarriageCertificateRemarks',
                            'BarangayIndigencyPath'      => 'BarangayIndigencyRemarks',
                            'CertificateOfResidencyPath' => 'CertificateOfResidencyRemarks',
                        ];

                        $remarksField = $remarksFieldMap[$fieldName] ?? null;
                        ...
                        try {
                            ...
                            $_SESSION['upload_error'] = "Database Sync Error: " . $e->getMessage();
                        }
...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="row mb-4 text-center">
            <div class="col-12">
                <h2 class="fw-bold text-dark mb-1"><i class="fas fa-file-shield me-2 text-royal"></i>UPLOADED DOCUMENTS</h2>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" id="docsTable">
                        ...
                        <tbody>
                            <?php
                            $hasAnyUploaded = false;
                            foreach ($groupedRequirements as $rowGroup):
                                $subDocsList = [];
                                $hasUploaded = false;
                            ...
                            <?php if (!$hasAnyUploaded): ?>
                                <tr>
                                    <td colspan="4" class="text-center py-5 text-muted">
                                        <i class="bi bi-journal-x" style="font-size:3rem;"></i>
                                        <p class="mt-2 mb-0">No uploaded documents found</p>
                                        <small>Please upload your requirements to proceed</small>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
